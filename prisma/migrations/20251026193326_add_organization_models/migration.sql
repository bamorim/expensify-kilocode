...
-- CreateIndex
CREATE INDEX "UserOrganization_role_idx" ON "public"."UserOrganization"("role");
...
-- CreateIndex
CREATE INDEX "Expense_submittedBy_idx" ON "public"."Expense"("submittedBy");
...
-- AddForeignKey
ALTER TABLE "public"."Expense" ADD CONSTRAINT "Expense_submittedBy_fkey" FOREIGN KEY ("submittedBy") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
